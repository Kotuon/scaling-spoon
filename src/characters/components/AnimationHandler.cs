...
public partial class AnimationHandler : Component
{
    ...
    [Export(PropertyHint.Enum, "CrimsonRed,golem,merchant")]
    ...
    public bool IsActive() { return animationPlayer.IsAnimationActive(); }
    ...
    public float CurrentFinishPercentage()
    {
        return (float)animationPlayer.CurrentAnimationPosition /
            (float)animationPlayer.CurrentAnimationLength;
    }
}
